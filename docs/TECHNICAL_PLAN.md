...
This document consolidates everything needed to build the Calorie Tracker app from the current migration checkpoint (PRs 1-3 complete) to public app store launch. Keep it in `docs/TECHNICAL_PLAN.md` in the repo and update it as decisions change.

> Execution checkpoint as of 2026-04-28: `docs/MIGRATION_PLAN.md` PRs 1-3 are complete and verified. Treat PR 4 `feat/supabase-client` as the next implementation step.
